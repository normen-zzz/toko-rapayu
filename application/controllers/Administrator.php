...
class Administrator extends CI_Controller
{
    ...
    public function subcategories($id_categories)
    {
        $this->form_validation->set_rules('name', 'Name', 'required', ['required' => 'Nama Sub kategori wajib diisi']);
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Sub Kategori - Admin Panel';
            $data['getSubCategories'] = $this->Categories_model->getSubCategories($id_categories);
            $this->load->view('templates/header_admin', $data);
            $this->load->view('administrator/add_subcategories_product', $data);
            $this->load->view('templates/footer_admin');
        } else {
            $data = array();
