                    ...
                    <tbody>
                        ...
                        foreach ($retur->result_array() as $items) : ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $items['id_product']; ?></td>
                                ...
                                <td style="text-align:center;"><?php echo $items['ket']; ?></td>
                                <td style="text-align:center;"><a href="<?php echo base_url() . 'admin/retur/hapus_retur/' . $items['id']; ?>" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> Batal</a></td>
                            </tr>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                ...
                                                <input type="hidden" name="harjul" value="<?php echo number_format($price); ?>">
                                                <input type="hidden" name="qty" value="1" required>
                                                <input type="hidden" name="keterangan" value="Rusak" required>
                                                <button id="add_return" data-id="<?= $id ?>" class="add_return btn btn-xs btn-info" title="Pilih"><span class="fa fa-refresh"></span> Retur</button>
